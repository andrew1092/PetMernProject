...
export default function NewProduct({match}) {
  ...
  const clickSubmit = () => {
    ...
    if (values.redirect) {
      return (<Redirect to={'/seller/product/edit/'+match.params.shopId}/>)
    }
    return (<div>
      <Card className={classes.card}>
        ...
        <CardActions>
          ...
          <Link to={'/seller/product/edit/'+match.params.shopId} className={classes.submit}><Button variant="contained">Cancel</Button></Link>
        </CardActions>
      </Card>
    </div>)
}
